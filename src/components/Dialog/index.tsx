...
import { atoms as a, flatten, native, useTheme } from '#/theme'
      ...
      <Portal>
        <View
          ...
          <BottomSheet
            ...
            topInset={insets.top}
            {...sheetOptions}
            snapPoints={sheetOptions?.snapPoints ?? ['90%']}
            ref={sheet}
            index={openIndex}
...
export const ScrollableInner = React.forwardRef<
  BottomSheetScrollViewMethods,
  DialogInnerProps
>(function ScrollableInner({ children, style, contentContainerStyle }, ref) {
  const insets = useSafeAreaInsets()
  return (
    <BottomSheetScrollView
      ...
      contentContainerStyle={[a.pb_4xl, contentContainerStyle]}
      ref={ref}>
      {children}
