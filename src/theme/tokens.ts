// https://github.com/bluesky-social/social-app/blob/ef24611a1f2a55f3ea4ca57d8044ca91a88e7923/src/alf/README.md
...
export const color = {
  ...
  black_25: `hsl(${BLACK_HUE}, 08%, 97%)`,
  black_50: `hsl(${BLACK_HUE}, 08%, 95%)`,
  black_100: `hsl(${BLACK_HUE}, 08%, 90%)`,
  black_200: `hsl(${BLACK_HUE}, 08%, 80%)`,
  black_300: `hsl(${BLACK_HUE}, 08%, 70%)`,
  black_400: `hsl(${BLACK_HUE}, 08%, 60%)`,
  black_500: `hsl(${BLACK_HUE}, 08%, 9%)`,
  black_600: `hsl(${GRAY_HUE}, 02%, 27%)`,
  black_700: `hsl(${GRAY_HUE}, 02%, 37%)`,
  black_800: `hsl(${GRAY_HUE}, 02%, 47%)`,
  black_900: `hsl(${GRAY_HUE}, 02%, 57%)`,
  black_950: `hsl(${GRAY_HUE}, 02%, 67%)`,
  black_975: `hsl(${GRAY_HUE}, 02%, 87%)`,
  ...
  red_25: `hsl(${RED_HUE}, 78%, 97%)`,
  red_50: `hsl(${RED_HUE}, 78%, 95%)`,
  red_100: `hsl(${RED_HUE}, 78%, 90%)`,
  red_200: `hsl(${RED_HUE}, 78%, 80%)`,
  red_300: `hsl(${RED_HUE}, 78%, 70%)`,
  red_400: `hsl(${RED_HUE}, 78%, 57%)`,
  red_500: `hsl(${RED_HUE}, 78%, 40%)`,
  red_600: `hsl(${RED_HUE}, 78%, 32%)`,
  red_700: `hsl(${RED_HUE}, 78%, 26%)`,
  red_800: `hsl(${RED_HUE}, 78%, 20%)`,
  red_900: `hsl(${RED_HUE}, 78%, 14%)`,
  red_950: `hsl(${RED_HUE}, 78%, 8%)`,
  red_975: `hsl(${RED_HUE}, 78%, 2%)`,
} as const
